...
import static com.inovationware.toolkit.common.domain.DomainObjects.HAPTIC_FEEDBACK_ONLY_KEY;
import static com.inovationware.toolkit.common.domain.DomainObjects.HAPTIC_FEEDBACK_ON_ACKNOWLEDGEMENT_KEY;
import static com.inovationware.toolkit.common.domain.DomainObjects.LAST_WEB_PAGE_SENT_KEY;
...
import static com.inovationware.toolkit.common.domain.DomainObjects.SHARED_PREFERENCES_BASE_URL_KEY;
import static com.inovationware.toolkit.common.domain.DomainObjects.SHARED_PREFERENCES_PROMPT_TO_SYNC_NOTE;
import static com.inovationware.toolkit.common.domain.DomainObjects.SHARED_PREFERENCES_SHOW_VOCABULARY;
import static com.inovationware.toolkit.common.domain.DomainObjects.SHARED_PREFERENCES_USERNAME_KEY;
...
import static com.inovationware.toolkit.common.domain.DomainObjects.SHARED_PREFERENCES_TARGET_MODE;
import static com.inovationware.toolkit.common.domain.DomainObjects.TARGET_MODES;
import static com.inovationware.toolkit.common.domain.DomainObjects.TARGET_MODE_TO_DEVICE;
import static com.inovationware.toolkit.common.domain.DomainObjects.TARGET_MODE_TO_GROUP;
...
public class SharedPreferencesManager {
    ...
    public void setSender(Context context, String sender) {
        setString(context, SHARED_PREFERENCES_SENDER, Code.clean(sender).length() > 0 ? Code.clean(sender) : defaultSender(context));
    }
    ...
    public void setBaseUrl(Context context, String url) {
        setString(context, SHARED_PREFERENCES_BASE_URL_KEY, Code.clean(url));
    }
    ...
    public void setTargetMode(Context context, String mode) {
        if (Code.clean(mode).equalsIgnoreCase(TARGET_MODE_TO_DEVICE) || Code.clean(mode).equalsIgnoreCase(TARGET_MODE_TO_GROUP))
