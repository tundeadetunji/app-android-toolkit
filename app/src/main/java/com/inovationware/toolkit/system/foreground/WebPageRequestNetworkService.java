...
public class WebPageRequestNetworkService extends Service {
    private static final int NOTIFICATION_ID = 901;
    private static final long INTERVAL = 5001;
    private final String CHANNEL_ID = "WEB_PAGE_REQUEST_NETWORK_SERVICE_CHANNEL_ID";
    private final String CHANNEL_NAME = "WEB_PAGE_REQUEST_NETWORK_SERVICE_CHANNEL";
    ...
    private Notification createNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setContentText("Tap to stop network services...")
